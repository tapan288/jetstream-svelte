...
class InstallCommand extends Command implements PromptsForMissingInput
{
    ...
    {
        if (!in_array($this->argument('stack'), ['inertia'])) {
            $this->components->error('Invalid stack. Supported stack is [inertia].');
...
EOF;
    ...
    protected function installInertiaStack()
    {
        ...
        // Inertia Pages...
        copy(__DIR__ . '/../../stubs/inertia/resources/js/Pages/Dashboard.svelte', resource_path('js/Pages/Dashboard.svelte'));
        copy(__DIR__ . '/../../stubs/inertia/resources/js/Pages/PrivacyPolicy.svelte', resource_path('js/Pages/PrivacyPolicy.svelte'));
        copy(__DIR__ . '/../../stubs/inertia/resources/js/Pages/TermsOfService.svelte', resource_path('js/Pages/TermsOfService.svelte'));
        copy(__DIR__ . '/../../stubs/inertia/resources/js/Pages/Welcome.svelte', resource_path('js/Pages/Welcome.svelte'));
